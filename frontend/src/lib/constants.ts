...
import { type Address, type TokenType } from '~/types';
...
const addressSchema = z.object({
  ...
  boxToken: z.string() as z.Schema<Address>,
...
export const contracts: Contracts = {
  ...
  boxToken: "0xa09bc0A647CE6c329053e0656c2CBf70279FF69D",
...
export const usdcToken: TokenType = {
  logo: usdcLogo,
  alt: "usdc logo",
  name: "USDC",
};